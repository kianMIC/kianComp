...
<head>
     ...
     <title>Memoria Ram | Kian_componentes</title>
<?php 
     include("cabecera.php");
     include("inicio_main.php");
?>
     		<h3><span class="linea">SEG</span>URO TE INTERESA NUESTROS<span class="negrita"> MEMORIAS RAM</span></h3>
     		<div id="interes">
                    <?php 
                         include("../php/conexion_bd.php");
                              $query = "SELECT * FROM productos WHERE categoria = 'RAM'";
