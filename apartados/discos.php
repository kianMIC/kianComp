...
<head>
     ...
     <title>Discos Duros | Kian_componentes</title>
<?php 
     include("cabecera.php");
     include("inicio_main.php");
?>
     		<h3><span class="linea">SEG</span>URO TE INTERESA NUESTROS<span class="negrita"> DISCOS DUROS</span></h3>
     		<div id="interes">
                    <?php 
                         include("../php/conexion_bd.php");
                              $query = "SELECT * FROM productos WHERE categoria = 'Discos Duros'";
